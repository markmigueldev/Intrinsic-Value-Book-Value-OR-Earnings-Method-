...
public class UI2 extends JFrame {
	...
	public UI2() {
		...
		JLabel lblNewLabel = new JLabel("Current EPS ($):");
		...
		lblNewLabel_1 = new JLabel("Old EPS ($):");
		...
		lblNewLabel_2 = new JLabel("Number of Years Between EPS:");
		...
		lblNewLabel_3 = new JLabel("Average EPS Change (%):");
		...
		lblNewLabel_5 = new JLabel("Current EPS ($):");
		...
		lblNewLabel_6 = new JLabel("Average EPS Change (%):");
